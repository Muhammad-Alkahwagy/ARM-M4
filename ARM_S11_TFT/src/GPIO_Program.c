...
/*Copy_u8AFNumber Options: AF0, AF1, AF2, AF3, AF4, AF5, AF6, AF7, AF8, AF9, AF10, AF11, AF12, AF13, AF14, AF15*/
/**
 * @brief 
 * 
 * @param Copy_u8PortID 
 * @param Copy_u8PinID 
 * @param Copy_u8AFNumber 
 */
void GPIO_voidSetPinAlternativeFunNo(u8 Copy_u8PortID, u8 Copy_u8PinID, u8 Copy_u8AFNumber)
{
	/*i/p validation*/
	if((Copy_u8PortID > PORTC) || (Copy_u8PinID > PIN15) || (Copy_u8AFNumber > AF15))
	{
		/*Do Nothing*/
	}
	else
	{
		if(Copy_u8PinID <= PIN7)
		{
			switch(Copy_u8PortID)
			{
				case PORTA:	GPIOA_AFRL |= (u32)(Copy_u8AFNumber << (Copy_u8PinID*4));	break;
				case PORTB:	GPIOB_AFRL |= (u32)(Copy_u8AFNumber << (Copy_u8PinID*4));	break;
				case PORTC:	GPIOC_AFRL |= (u32)(Copy_u8AFNumber << (Copy_u8PinID*4));	break;
				default:
							break;
			}
		}
		else
		{
			switch(Copy_u8PortID)
			{
				case PORTA:	GPIOA_AFRH |= (u32)(Copy_u8AFNumber << ((Copy_u8PinID % 8)*4));	break;
				case PORTB:	GPIOB_AFRH |= (u32)(Copy_u8AFNumber << ((Copy_u8PinID % 8)*4));	break;
				case PORTC:	GPIOC_AFRH |= (u32)(Copy_u8AFNumber << ((Copy_u8PinID % 8)*4));	break;
				default:
							break;
			}
		}
...
/*
void GPIO_voidSetPinAltFun(u8 Copy_u8PortName ,u8 Copy_u8PinNum, u8 Copy_u8AlFun)
{
	if(Copy_u8PinNum <=7U)
	{
